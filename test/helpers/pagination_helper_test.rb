...
class PaginationHelperTest < ActionView::TestCase
  ...
  def expected_output_display_next_previous_link
    '<nav class="page-numbers-container pagination-container"><div class="previous"><a href' \
  ...
  def expected_output_display_next_link_only
    '<nav class="page-numbers-container pagination-container"><div class="next"' \
  ...
  def expected_output_display_previous_link_only
    '<nav class="page-numbers-container pagination-cont' \
