...
class RefreshCodeXrefDataJob < ApplicationJob
  ...
  def self.schedule_next_run(how_long = nil)
    ...
    super(get_interval(how_long, Rails.configuration.x.scheduled_jobs.refresh_code_xref_data_every,
  ...
  def job_action
    ReferenceData::CodeXrefValue.refresh_cache!
  end
end
