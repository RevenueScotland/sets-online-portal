...
$(function () {
    $.widget("custom.combobox", {
        _create: function () {
            ...
            // This is used to pass all the classes we need, we'll change the classes to the
            // appropriate class names.
            var classes = this.element.attr("class").replace("govuk-select", "govuk-input")
                .replace("govuk-select--error", "govuk-input--error")
                .replace("combobox", "");
            ...
            // The classes parameter is used to pass all the classes of the original field, but converted
            // to have the appropriate class names (from "select" to "input").
            this._createAutocomplete(this.element.attr("name"), this.element.attr("id"),
                this.element.attr("aria-describedby"), classes);
            this._createShowAllButton();
            this.element.removeAttr("id");
        },

        _createAutocomplete: function (name, id, describedby, classes) {
