...
Rails.application.configure do
  ...
  # we always configured REDIS at the application level as we use it for data caching
  ...
  # Prevent the schedule jobs running by setting to 0.seconds, if you want them to run then set the offset
