...
if [[ -n "$version" ]] && [[ -n "$environment" ]]  && [[ -n "$dockerImageName" ]]; then
	...
	echo export INT_PROXY_HTTP_PORT=8887 >> scratch/$version/$environment/additional.env
	echo export INT_PROXY_HTTPS_PORT=8888 >> scratch/$version/$environment/additional.env
	echo export PROXY_HTTP_PORT=8887 >> scratch/$version/$environment/additional.env
	echo export PROXY_HTTPS_PORT=8888 >> scratch/$version/$environment/additional.env
