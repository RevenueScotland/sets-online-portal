...
Feature: Dashboard All Returns
    ...
    Scenario: Check draft stops amend link being shown
        ...
        And the table of data is displayed
            ...
            | RS2000001AAAA    | CO99999.0001            | 01/07/2019     | Conveyance or transfer | 1       | £200.00 | Filed (Debit) | Download PDF | Transactions | Message  | Draft Present |
            | RS2000004DDDD    | ABcC                    | 01/07/2019     | Conveyance or transfer | 1       | £0.00   | Filed (Paid)  | Download PDF | Transactions | Amend    | Message       |
            | RS3000004DDDD    | ABcC                    | 01/07/2019     | Conveyance or transfer | 1       | £0.00   | Filed (Paid)  | Download PDF | Transactions | Amend    | Message       |
    ...
    Scenario: Filter data to list down all that's needed to be seen
        ...
        Then the table of data is displayed
            ...
            | RS1008003OKAY    |                | Q3 2018     | 3       | £0.00   | Draft        | Download PDF | Download waste details | Delete          | Ongoing Enquiry |                 |
            | RS1008003OKAY    | 03/07/2019     | Q3 2018     | 2       | £0.00   | Filed (Paid) | Download PDF | Download waste details | Transactions    | Message         | Ongoing Enquiry |
            | RS1008003OKAY    | 03/07/2019     | Q3 2018     | 1       | £0.00   | Filed (Paid) | Download PDF | Download waste details | Ongoing Enquiry |                 |                 |
    ...
    Scenario: Checking action links are correctly shown for specific type of returns
        ...
        When I open the "Show more filter options" summary item
        And I enter "01-07-2019" in the "Submitted from date" date field
