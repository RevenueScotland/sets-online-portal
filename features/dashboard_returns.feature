...
Feature: Dashboard All Returns
    ...
    Scenario: View list of all returns
        ...
        And the table of data is displayed
            ...
            | RS100002AAAAA    | Q2 2023     | 1       | Continue     | Download PDF           | Download waste details | Delete          |
        ...
        And the table of data is displayed
            ...
            | RS100001AAAAA    | 01/07/2023     | Q1 2023     | 2       | £1,000.00 | Filed (Debit) | Transactions | Download PDF | Download waste details | Amend    | Message  |
        ...
        Then the table of data is displayed
            ...
            | RS100002AAAAA    |                | Q2 2023     | 1       |           | Draft         | Download PDF | Download waste details | Continue     | Delete          |                 |
            ...
            | RS1008001HALO    | 01/07/2023     | Q1 2016     | 2       | £0.00     | Filed (Paid)  | Download PDF | Download waste details | Transactions | Claim           | Message         |
            | RS100001AAAAA    | 01/07/2023     | Q1 2023     | 2       | £1,000.00 | Filed (Debit) | Download PDF | Download waste details | Transactions | Amend           | Message         |
            | RS1008004HMMM    | 19/06/2023     | Q2 2019     | 1       | £0.00     | Filed (Paid)  | Download PDF | Download waste details | Transactions | Amend           | Message         |
        And I should not see the text "Q1 2019"
