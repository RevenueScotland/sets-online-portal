...
Feature: Roles and Actions
  ...
  Scenario: Has not got access to anything
    ...
    And I should not see a link with text "Create or update users for this account"
    When I go to the "account/edit-basic" page
    Then I should see the "You are not authorised to view this page" page
  ...
  Scenario: Read only access to messages
    ...
    And I should not see a link with text "Reply"
    When I go to the "dashboard/messages/new" page
